    ...
    .then((response) => {
      if (response.data.success) {
        ...
        const mappedApiProjects = apiProjects.map((project, index) => ({
          ...
          bottomImage: [BottomImg1, BottomImg2, BottomImg3, BottomImg4][index % 4] || BottomImg1,
          slug: project.slug || slugify(project.name || 'untitled-project', { lower: true, strict: true }), // Generate slug if not provided
        }));
  ...
  const getAnimationProps = (width) => {
    ...
    if (width <= 375) {
      props = {
        ...
        logoTo2: { y: 946, x: -69, scale: 0.1, duration: 6 },
    ...
    // Adjust for specific breakpoints
      ...
      props = {
        ...
        scrollImageTo: { opacity: 0, duration: 0.15 },
        pathsTo: { fill: '#c1d1e0', stroke: '#c1d1e0', duration: 1.5 },
        logoTo2: { y: 900, x: -39, scale: 0.1, duration: 6 },
        logoTo3: { opacity: 0, duration: 0.1 },
        scrollTrigger: { start: 'top 30%', end: 'bottom 47%', scrub: 0.7 },
      };
    } else if (width <= 574) {
      props = {
        ...
        logoTo2: { y: 830, x: 39, scale: 0.1, duration: 9 },
      ...
      props = {
        ...
        scrollImageTo: { opacity: 0, duration: 0.2 },
        pathsTo: { fill: '#c1d1e0', stroke: '#c1d1e0', duration: 0.6 },
        logoTo2: { y: 285, x: 260, scale: 0.1, duration: 2.6 },
        logoTo3: { opacity: 0, duration: 0.5 },
      ...
      props = {
        ...
        scrollImageTo: { opacity: 0, duration: 0.2 },
        pathsTo: { fill: '#c1d1e0', stroke: '#c1d1e0', duration: 0.6 },
        logoTo2: { y: 337, x: 306, scale: 0.1, duration: 4.6 },
        logoTo3: { opacity: 0, duration: 0.5 },
      ...
      props = {
        ...
        logoTo2: { y: 472, x: 551, scale: 0.1, duration: 4.6  },
        logoTo3: { opacity: 0, duration: 0.5 },
      ...
      props = {
        ...
        scrollImageTo: { opacity: 0, duration: 1.1, scrub: 1 },
        pathsTo: { fill: '#c1d1e0', stroke: '#c1d1e0', scrub: 3 },
        logoTo2: { y: 475, x: 620, scale: 0.1, duration: 4.6  },
        logoTo3: { opacity: 0, duration: 0.5 },
        scrollTrigger: { start: 'top 75%', 
          end: 'bottom 49%',
        ease: 'power3.out', scrub: 2.3 },
      ...
      props = {
        ...
        scrollImageTo: { opacity: 0, duration: 1.1, scrub: 1 },
        pathsTo: { fill: '#c1d1e0', stroke: '#c1d1e0', scrub: 3 },
        logoTo2: { y: 469, x: 650, scale: 0.1, duration: 4.6  },
        logoTo3: { opacity: 0, duration: 0.5 },
        scrollTrigger: { start: 'top 75%', 
          end: 'bottom 49%',
        ease: 'power3.out', scrub: 2.3 },
      ...
      props = {
        ...
        scrollImageTo: { opacity: 0, duration: 0.2 },
        pathsTo: { fill: '#c1d1e0', stroke: '#c1d1e0', duration: 0.6 },
        logoTo2: { y: 470, x: 725, scale: 0.1, duration: 4.2 },
        logoTo3: { opacity: 0, duration: 0.5 },
  ...
  images.forEach((img, index) => {
    ...
    const getOffsets = () => {
      ...
      return {
        ...
        y: cardImgRect.top - 229 + imgRect.height / 2 - imgRect.top,
      };
    };
  ...
  gsap.to([section2Image], {
    ...
    const getAnimationProps1 = (width) => {
      ...
      if (width <= 425) {
        ...
        props = {
          fromTo: {
            from: { opacity: 0, y: -190, x: 1170 ,scale: 1.3, scrub: 1},
          ...
          scrollTrigger: { start: 'top 65%', end: 'bottom 45%', duration: 3.5,scrub: 2.6 },
        };
      } 
      else if (width <= 1700) {
        props = {
    ...
    style={{ position: 'relative', zIndex: 2 }}
                >
                  ...
                  <Card.Body className="uper-space">
                    ...
                    <Button
                        className="Up-arrow-btn all-same-ani"
                        onClick={() => navigate(`/project/${project.slug}`)} // Navigate to project details
                      >
